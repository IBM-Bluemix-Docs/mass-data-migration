...
This capability is available as part of the {{site.data.keyword.mdms_short}} beta release. To find out more about participating in our beta program, check out [Getting access to beta]().
{: note}
